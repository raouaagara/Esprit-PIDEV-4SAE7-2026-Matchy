...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-BOA6XJLV.js").then((m) => m.authRoutes)
  },
  {
    path: "client",
    canActivate: [authGuard, clientGuard],
    loadChildren: () => import("./chunk-LAVADY5O.js").then((m) => m.clientRoutes)
  },
  {
    path: "organizer",
    canActivate: [authGuard, organizerGuard],
    loadChildren: () => import("./chunk-UGG7OCVG.js").then((m) => m.organizerRoutes)
  },
