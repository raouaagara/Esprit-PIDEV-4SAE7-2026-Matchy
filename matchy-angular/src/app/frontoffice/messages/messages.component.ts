...
import { Message, CreateMessageRequest, Project } from '../models/models';
import { interval, Subscription } from 'rxjs';
import { switchMap } from 'rxjs/operators';

@Component({
  selector: 'app-fo-messages',
...
export class MessagesComponent implements OnInit, OnDestroy {
  ...
  loadProjects() {
    this.loading = true;
    // Load projects where user is involved (either as company or freelancer)
    // For freelancers, we'll load open projects they might be working on
    this.projectService.getOpenProjects().subscribe({
      next: (projects: Project[]) => {
        // For now, show all open projects
        // In production, filter by projects where freelancer has accepted applications
