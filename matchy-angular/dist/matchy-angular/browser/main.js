...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-54YORYJG.js").then((m) => m.FrontofficeModule)
  },
  {
    path: "backoffice",
    loadChildren: () => import("./chunk-3ROMZ6ZZ.js").then((m) => m.BackofficeModule)
  },
  {
    path: "**",
    redirectTo: ""
...
var AppComponent = class _AppComponent {
  constructor(authService, darkModeService, renderer) {
    this.authService = authService;
    this.darkModeService = darkModeService;
    this.renderer = renderer;
    this.title = "matchy-angular";
  }
  ngOnInit() {
  ...
  applyBackgroundStyles() {
    ...
    this.renderer.setStyle(document.body, "background", isDark ? "#1a1d2e" : "#f8f9fc");
    if (!document.getElementById("gradient-overlay")) {
      ...
      if (isDark) {
        this.renderer.setStyle(overlay, "background", "radial-gradient(circle at 20% 30%, rgba(102, 126, 234, 0.2) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(139, 92, 246, 0.2) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(59, 130, 246, 0.15) 0%, transparent 70%)");
      } else {
        this.renderer.setStyle(overlay, "background", "radial-gradient(circle at 20% 30%, rgba(102, 126, 234, 0.12) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(139, 92, 246, 0.12) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(59, 130, 246, 0.08) 0%, transparent 70%)");
      }
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(DarkModeService), \u0275\u0275directiveInject(Renderer2));
    };
  }
  static {
...
// src/app/frontoffice/interceptors/auth.interceptor.ts
